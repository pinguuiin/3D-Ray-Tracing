...
/*   Updated: 2025/10/14 23:52:55 by piyu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	info->obj[1].pos = vec3(0.0, -2.0, 30.0);  // what if o and c overlap
